...
level 5: i changed the url to be https://xss-game.appspot.com/level5/frame/signup?next=alert("let this alert you") on the sign up page were the alert is "let this alert you". The following line in signup.html   <link rel="stylesheet" href="/static/game-frame-styles.css" /> 
